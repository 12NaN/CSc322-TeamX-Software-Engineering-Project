    ...
    render() {
        ...
        return (
            <div>
                ...
                <hr></hr>
                <Sections sectionName="Voting" privacy={localStorage && this.state.memNames.length != 0 && localStorage.usertoken && this.state.memNames.includes(this.state.user_id)  ? false : this.state.visi_posts} component={<VoteSection group= {this.state.id} user= {this.state.user_name} members={this.state.members}/>}/>
                <hr></hr>
